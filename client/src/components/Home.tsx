...
<h4>Reallığınızı həqiqi potensialınızla uyğunlaşdırın.</h4>
<h1>Tükənmişlikdən Liderliyə, Təklikdən Əlaqəyə, Xaosdan Bolluğa:</h1>
<p>

90 Gündən Az Müddətdə Daxili Potensialınızı Üzə Çıxararaq Özünüz Üçün Daha Azad, Daha Orijinal və daha Güclü Həyat Yaratmağa Cəmi Bir Addım Qalırsınız.</p>
      </div>
      {/* video section starts */}
      <section className='video__section'>
  <div>
   <iframe  src="https://www.youtube.com/embed/i2j3qjm--24?si=cLMRJgLDJl4JMSed" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"   />
  </div>
